"""
下载指数日线行情（Tushare doc_id=95），默认上证指数 000001.SH。
...
示例：
python scripts/download_sse_index_daily.py
python scripts/download_sse_index_daily.py --ts-code 000001.SH --start-date 19900101 --end-date 20260228
"""
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="下载指数日线行情（默认上证指数）")
