...
from strategy.capital_diffusion_3_5d_strategy import CapitalDiffusion35DStrategy  # noqa: E402


def parse_args():
    p = argparse.ArgumentParser(description="运行资金扩散突破策略信号")
...
def main():
    args = parse_args()
    strategy = CapitalDiffusion35DStrategy(top_n=args.top_n)
